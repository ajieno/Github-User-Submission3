...
var filterListFollower = ArrayList<User>()

class ListFollowerAdapter(private  val listfollowerr: ArrayList<User>) : RecyclerView.Adapter<ListFollowerAdapter.ListViewHolder>() {

    init {
        filterListFollower = listfollowerr
    }
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val userdata = listfollowerr [position]
